# Laravel-FCM. With Laravel 7.x support.

Link to the original repository https://github.com/brozot/Laravel-FCM.
...
To get the latest version of Laravel-FCM on your project, require it from "composer":
	...
	$ composer require zmbakh/laravel-fcm
...
Copy the config file ```fcm.php``` manually from the directory ```/vendor/zmbakh/laravel-fcm/config``` to the directory ```/config ``` (you may need to create this directory).
